...
Normal Q-Q: The normal Q-Q shows residuals that are normal because they do follow a straight line (although they are sort of not straight after 2 on the theoretical quantile).
...
Residuals vs Leverage This plot shows the influence outliers have on the model, and although nearly all the observations are within cook's distance (except 226), some are labeled illustrating that if they were taken out they would change the estimates.
